...
class Productmodel_pilihanpromo extends CI_Model
{ 
    private $_table = "pilihan_promo";

    public $kd_pilihan;
    public $pilihan_promo;
    public $batas_promo;
    public $status;
    ...
    {
        return $this->db->get_where($this->_table, ["kd_pilihan" => $kd])->row();
    }

    public function save()
    {
        $post = $this->input->post();
        $this->kd_pilihan = $post["kd_pilihan"];
        $this->pilihan_promo = $post["pilihan_promo"];
    ...
    public function update()
    {
        ...
        // $this->harga_barang = $post["harga_barang"];
        $data = array(
            "kd_pilihan" => $post["kd_pilihan"],
            "pilihan_promo" => $post["pilihan_promo"],
        ...
        $this->db->where("kd_pilihan",$post["kd_pilihan"]);
        $this->db->update("pilihan_promo", $data);
    ...
    public function delete($id)
    {
        ...
        // $this->harga_barang = $post["harga_barang"];
        //return
        $this->db->where("kd_pilihan",$id);
        $this->db->delete("pilihan_promo");
