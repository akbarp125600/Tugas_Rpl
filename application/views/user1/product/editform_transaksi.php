			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
						...
						<form action="<?php base_url('admin/product/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('price') ? 'is-invalid':'' ?>"
								 type="text" name="barang_jual" placeholder="tulisen jenenge" value="<?php echo $product->barang_jual ?>" />
								<div class="invalid-feedback">
					...
					<!--		<div class="form-group">
							...
							<div class="form-group">
								<label for="price">id_barang</label>
								<input class="form-control <?php echo form_error('id_barang') ? 'is-invalid':'' ?>"
								 type="text" name="id_barang" placeholder="akeh ta barange" value="<?php echo $product->id_barang ?>" />
								<div class="invalid-feedback">
