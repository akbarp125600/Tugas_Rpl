			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<!-- <div class="card-header">
						<a href="<?php echo site_url('admin/products_transaksi/add') ?>"><i class="fas fa-plus"></i> Add New</a>
					</div> -->
					<div class="card-body">
							...
							<table class="table table-hover" id="dataTable" width="150%" cellspacing="0">
								...
								<tbody>
									...
									<!--	<td>
										...
										<td width="200">
											<!--<a href="<?php echo site_url('admin/products_transaksi/edit/'.$product->id_transaksi) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('admin/products_transaksi/delete/'.$product->id_transaksi) ?>')"
											 href="javascript:;" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus</a>
											a <a onclick="deleteConfirm('<?php echo site_url('admin/products_transaksi/delete/'.$product->id_transaksi) ?>')"
