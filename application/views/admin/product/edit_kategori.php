			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/products_kategori/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
						...
						<form action="<?php base_url('admin/product/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<input type="hidden" name="id" value="<?php echo $product->id_kategori?>" />

							<div class="form-group">
								<label for="name">id</label>
								<input class="form-control <?php echo form_error('id_kategori') ? 'is-invalid':'' ?>"
								 type="text" name="id_kategori" placeholder="nomere piro slur" value="<?php echo $product->id_kategori ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('kategori') ? 'is-invalid':'' ?>"
								 type="text" name="kategori" placeholder="tulisen jenenge" value="<?php echo $product->kategori ?>" />
								<div class="invalid-feedback">
