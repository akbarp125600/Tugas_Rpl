			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/products_transaksi/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">
						...
						<form action="<?php base_url('admin/product/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('id_transaksi') ? 'is-invalid':'' ?>"
								 type="text" name="id_transaksi" placeholder="nomer barang" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('barang_jual') ? 'is-invalid':'' ?>"
								 type="text" name="barang_jual" placeholder="stok" />
								<div class="invalid-feedback">
									<?php echo form_error('barang_jual') ?>
								</div>
							</div>
