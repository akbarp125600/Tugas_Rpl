...
class Products_transaksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $dataz["Products_transaksi"] = $this->productmodel_transaksi->userby();
        $dataz["notif"] = $this->productmodel_transaksi->getNotif($this->session->userdata('user_id'));
        $this->load->view("user/product/listform_transaksi", $dataz);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("user/product/newform_transaksi", $dataz);
    }

    public function edit($idz = null)
    {
        $id = $idz;
        if (!isset($id)) redirect('user/Products_transaksi');
...
//                    'harga_barang' => $this->input->post('harga_barang'),
  ...
  //                  'diskripsi' => $this->input->post('diskripsi'),
                    ...
                    'waktu' => date("Y-m-d H:i:s"), //cara format tanggal
        ...
        $this->load->view("user/product/editform_transaksi", $dataz);
    }
    ...
    public function delete($id=null)
    {
        ...
        redirect('user/Products_transaksi');
    }
