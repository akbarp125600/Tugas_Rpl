...
class Products_halaman extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model("productmodel_halaman");
    ...
    public function index()
    {
        ...
        $dataz["Products_halaman"] = $this->productmodel_halaman->getAll();
    ...
    public function transaksi()
    {
        ...
        $dataz["data_user"] = $this->productmodel_halaman->getByIduser($id_user);
        $dataz["data_barang"] = $this->productmodel_halaman->getByIdbarang($id_barang);
    ...
    public function add()
    {
        $product = $this->productmodel_halaman;
